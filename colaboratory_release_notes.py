...
* Python runtimes upgraded to Python 3.12. [GitHub](https://github.com/googlecolab/colabtools/issues/5483)
* Julia runtimes upgraded to Julia 1.11. [GitHub](https://github.com/googlecolab/colabtools/issues/5408)
* Launched [Interactive Slideshow Mode for lectures](https://blog.google/outreach-initiatives/education/colab-higher-education/). It provides a better viewing experience for presentations making lessons more dynamic.
* Launched [AI toggle per notebook](https://blog.google/outreach-initiatives/education/colab-higher-education/).
...
* Terminal is now available to all users, free of charge! ([X](https://x.com/GoogleColab/status/1937248640252412093), [Colab Notebook](https://colab.research.google.com/notebooks/snippets/colab_models_as_a_service.ipynb))
* The new Colab AI experience is now available to all users. This version has an agentic collaborator run with Gemini 2.5 Flash and enhances productivity with features like iterative querying, a next-gen data science agent, code transformation, and more to significantly improve coding workflows for developers. ([Blog](https://developers.googleblog.com/en/new-ai-first-google-colab-now-available-to-everyone/), [X](https://x.com/GoogleColab/status/1937557047186530782))
* Introducing our new google.colab.ai library! Pro & Pro+ subscribers can access powerful Gemini and Gemma models with just a few lines of code- no set up or API key required! Try it out! ([X](https://x.com/GoogleColab/status/1944895802180296826), [Colab Notebook](https://colab.research.google.com/notebooks/snippets/colab_models_as_a_service.ipynb))
* Big news for data science in higher ed! 🚀 Colab now offers 1-year Pro subscriptions free of charge for verified US students/faculty, interactive Slideshow Mode for lectures, & an AI toggle per notebook. Enhance teaching & learning in the upcoming academic year! Read all about it [here](https://goo.gle/40pxnl1). ([X](https://x.com/GoogleColab/status/1946269436207669274))
* Gemini CLI installed on runtimes. Try it out in the Terminal! ([github](https://github.com/google-gemini/gemini-cli), [npm](https://www.npmjs.com/package/@google/gemini-cli))
...
* At Google I/O Colab announced a new, reimagined AI-first Colab, bringing a
powerful agentic collaborator into the notebook. Learn more [here](https://developers.googleblog.com/en/fully-reimagined-ai-first-google-colab/).
* Huggingface integration: We’ve partnered with Hugging Face to add “Open in
...
experiment with and evaluate models. View the announcement [blog](https://medium.com/google-colab/launch-hugging-face-models-in-colab-for-faster-ai-exploration-bee261978cf9) to learn more
...
* Launched Colab's fastest deep learning accelerator: v6e-1 (Trillium) TPUs!! 2x the high bandwidth memory as v5e-1 (32GB) and a whopping peak rating of 918 BF16 TFLOPS (nearly 3x A100)!️ Try them out with JAX & Flax in our [example notebook](https://colab.sandbox.google.com/notebooks/jax_tpu_v6e1.ipynb)
...
*   Colab Data Science Agent [launched](https://developers.googleblog.com/en/data-science-agent-in-colab-with-gemini/)!
*   Julia language runtimes available with GPU and TPU support [GitHub](https://github.com/googlecolab/colabtools/issues/5151).
...
*   Released version 1.2.0 of the ([Open in Colab Chrome Extension](https://github.com/googlecolab/open_in_colab)).
*   Released minimizable comments with indicators next to cell.
*   TPU v5e-1 Runtimes are now available for selection ([tweet](https://twitter.com/GoogleColab/status/1869458629230993619)).
*   GPU prices were decreased ([tweet](https://twitter.com/GoogleColab/status/1869458629230993619)).
